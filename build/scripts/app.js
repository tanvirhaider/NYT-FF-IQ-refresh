...
function fixCloneEventListenerIssue() {
  ...
  for (var i = 0; i < clonedItems.length; i++) {
    ...
    currentItem.addEventListener("click", articleClicked, false); // console.log(currentItem);
  }
}
...
function createArticleFrame(data) {
  ...
  frame.setAttribute('data-index-number', frameNum); //console.debug(event.target.dataset.indexNumber);    
